...
public class TryAgain {
  ...
  public static void main(String[] args)   {
     double paintPrice, wall, gallons, hours;
    ...
    Scanner readObject = new Scanner(System.in);
        System.out.println("Enter the price of paint"
                             + "per gallon");
       paintPrice = readObject.nextDouble();
        System.out.println("Enter the sq ft of wall to"
                             + " be painted");
        wall = readObject.nextDouble();
    welcomeMessage(); 
   
    System.out.println("The price of paint is " + paintPrice + ".");
    System.out.println("The area to be painted is" + wall + "sq ft.");
  ...
  public static void welcomeMessage() {
    ...
    public static double tPC() {
      double totalPaintCost, paintPrice;
      totalPaintCost= (g() * paintPrice);
